...
const AddProduct: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    image_url: '',
    // Product variants
    variants: [] as Array<{ name: string; value: string; price_adjustment: string; stock_quantity: string }>
  });
  ...
  const uploadImageToCloudinary = async (file: File): Promise<string> => {
    // This is a mock function - replace with your actual image upload service
    // You can use Cloudinary, AWS S3, or any other image hosting service
              ...
              <div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  {formData.image_url && !selectedFile && (
                    <div className="w-16 h-16 bg-secondary-200 rounded-lg overflow-hidden">
                      <img
