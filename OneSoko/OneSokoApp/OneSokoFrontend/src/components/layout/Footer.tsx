        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-secondary-300 text-sm leading-relaxed">
              Your one-stop marketplace connecting customers with local businesses. 
              Discover amazing products from verified shops across Kenya.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/shops" className="text-secondary-300 hover:text-primary-400 transition-colors">
                  Shops
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/help" className="text-secondary-300 hover:text-primary-400 transition-colors">
                  Help Center
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/track-order" className="text-secondary-300 hover:text-primary-400 transition-colors">
                  Track Your Order
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-secondary-300">support@onesoko.co.ke</span>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-sm text-secondary-300">
              © {currentYear} OneSoko. All rights reserved.
            </div>
