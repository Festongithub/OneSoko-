...
const EditProductModal: React.FC<EditProductModalProps> = ({
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      if (product) {
        ...
        setValue('promotional_price', product.promotional_price || undefined);
  ...
  const onSubmit = async (data: EditProductFormData) => {
    if (!shop || !product) {
      alert('No shop or product selected');
      return;
    }
    ...
    try {
      ...
      const updatedProduct = await shopsAPI.updateProduct(shop.shopId, product.productId, formData);
